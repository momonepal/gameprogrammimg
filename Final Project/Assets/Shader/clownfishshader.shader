Shader "Unlit/clownfishshader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                half sinUse = sin(-_Time.x * _WaveSpeed + _MoveOffset + v.vertex.x * _WaveDensity);
                ...
                v.vertex.z = v.vertex.z + sin(-_Time.x * _StrideSpeed + _MoveOffset) * _StrideStrength;
